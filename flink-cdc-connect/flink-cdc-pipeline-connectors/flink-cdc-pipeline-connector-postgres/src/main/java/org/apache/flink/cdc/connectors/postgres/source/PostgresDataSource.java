...
public class PostgresDataSource implements DataSource {
    ...
    public PostgresDataSource(PostgresPipelineSourceConfigFactory configFactory) {
        ...
        org.apache.flink.cdc.connectors.postgres.source.config.PostgresSourceConfig cdcConfig =
                configFactory.create(0);
        ...
        LOG.info(
                "Created PostgresDataSource with slot: {}, plugin: {}",
                slotName,
                decodingPluginName);
    }
    ...
    private String extractDecodingPluginName(
            org.apache.flink.cdc.connectors.postgres.source.config.PostgresSourceConfig cdcConfig) {
        try {
    ...
    public EventSourceProvider getEventSourceProvider() {
        ...
        org.apache.flink.cdc.connectors.postgres.source.config.PostgresSourceConfig sourceConfig =
                configFactory.create(0);
        ...
        org.apache.flink.cdc.connectors.postgres.source.PostgresSourceBuilder
                                .PostgresIncrementalSource<
                        Event>
                source =
                        org.apache.flink.cdc.connectors.postgres.source.PostgresSourceBuilder
                                .PostgresIncrementalSource.<Event>builder()
                                ...
                                .tableList(
                                        sourceConfig
                                                .getTableList()
                                                .toArray(new String[0])) // CRITICAL: Add table list
    ...
    private static class PostgresMetadataAccessor implements MetadataAccessor {
        ...
        public PostgresMetadataAccessor(PostgresPipelineSourceConfigFactory configFactory) {
            ...
            org.apache.flink.cdc.connectors.postgres.source.config.PostgresSourceConfig config =
                    configFactory.create(0);
        ...
        public List<String> listNamespaces() {
            throw new UnsupportedOperationException(
                    "List namespace is not supported by PostgreSQL.");
        }
        ...
        private PostgresSchemaDiscovery createSchemaDiscovery(
