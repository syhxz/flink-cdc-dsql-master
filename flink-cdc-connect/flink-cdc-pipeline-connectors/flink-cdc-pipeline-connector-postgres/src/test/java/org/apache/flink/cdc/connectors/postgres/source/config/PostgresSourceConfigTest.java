...
class PostgresSourceConfigTest {
    ...
    void testConfigWithDifferentStartupOptions() {
        ...
        PostgresSourceConfig snapshotConfig =
                new PostgresSourceConfig(
                        hostname,
                        port,
                        username,
        ...
        PostgresSourceConfig latestConfig =
                new PostgresSourceConfig(
                        hostname,
                        port,
                        username,
                        ...
                        tableList,
                        slotName,
                        StartupOptions.latestOffset());

        PostgresSourceConfig specificConfig =
                new PostgresSourceConfig(
                        hostname,
                        port,
                        username,
                        ...
                        tableList,
                        slotName,
                        StartupOptions.specificOffset("0/1234567"));

        PostgresSourceConfig timestampConfig =
                new PostgresSourceConfig(
                        hostname,
                        port,
                        username,
                        ...
                        tableList,
                        slotName,
                        StartupOptions.timestamp(System.currentTimeMillis()));
