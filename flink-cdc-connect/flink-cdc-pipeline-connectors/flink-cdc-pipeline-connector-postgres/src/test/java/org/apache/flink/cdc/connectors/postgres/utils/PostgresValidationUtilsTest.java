...
class PostgresValidationUtilsTest {
    ...
    void testValidConfigurationPasses() {
        ...
        assertThatCode(() -> PostgresValidationUtils.validateConfiguration(config))
    ...
    private Configuration createConfigurationWithout(
            org.apache.flink.cdc.common.configuration.ConfigOption<?> excludeOption) {
        Configuration config = new Configuration();
