...
public class PostgresTableNameFormatterIntegrationTest {
    ...
    void testTableNamesWithExplicitSchema() {
        ...
        String[] formatted =
                PostgresTableNameFormatter.formatTableList(
                        "public", "public.users,inventory.products");
    ...
    void testMixedTableNameFormats() {
        ...
        String[] formatted =
                PostgresTableNameFormatter.formatTableList(
                        "public", "users,inventory.products,public.orders");
    ...
    void testTableNameFormattingWithWhitespace() {
        ...
        String[] formatted =
                PostgresTableNameFormatter.formatTableList("public", " users , orders , products ");
    ...
    void testSpecialCharacterHandling() {
        ...
        String[] formatted =
                PostgresTableNameFormatter.formatTableList("public", "user_data,order-history");
    ...
    void testCaseSensitiveTableNames() {
        ...
        String[] formatted =
                PostgresTableNameFormatter.formatTableList("public", "Users,ORDERS,MixedCase");
    ...
    void testIdentifierEscaping() {
        ...
        assertEquals(
                "\"already_escaped\"",
                PostgresTableNameFormatter.escapeIdentifier("\"already_escaped\""));
    }
    ...
    void testRealDatabaseTableNames() throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection(jdbcUrl, connectionProps);
            ...
            String[] formatted =
                    PostgresTableNameFormatter.formatTableList("public", "test_users,test_orders");
            ...
            for (String tableName : formatted) {
                ...
                String query =
                        String.format(
                                ...
                                PostgresTableNameFormatter.escapeIdentifier(
    ...
    void testMultiSchemaFormatting() throws Exception {
        ...
        String[] formatted =
                PostgresTableNameFormatter.formatTableList(
                        "public", "test_users,inventory.test_products,analytics.test_reports");
    ...
    private void setupTestDatabase() throws Exception {
        try (Connection conn = DriverManager.getConnection(jdbcUrl, connectionProps);
            ...
            stmt.execute(
                    "CREATE TABLE IF NOT EXISTS inventory.test_products ("
                            + "id SERIAL PRIMARY KEY, "
                            + "name VARCHAR(255) NOT NULL, "
                            + "price DECIMAL(10,2))");

            stmt.execute(
                    "CREATE TABLE IF NOT EXISTS analytics.test_reports ("
                            + "id SERIAL PRIMARY KEY, "
            ...
            stmt.execute(
                    "INSERT INTO public.test_users (name) VALUES ('Test User 1'), ('Test User 2')");
            stmt.execute("INSERT INTO public.test_orders (user_id) VALUES (1), (2)");
            stmt.execute(
                    "INSERT INTO inventory.test_products (name, price) VALUES ('Product 1', 99.99), ('Product 2', 149.99)");
            stmt.execute(
                    "INSERT INTO analytics.test_reports (report_name) VALUES ('Monthly Report'), ('Weekly Report')");
        }
    }
}
