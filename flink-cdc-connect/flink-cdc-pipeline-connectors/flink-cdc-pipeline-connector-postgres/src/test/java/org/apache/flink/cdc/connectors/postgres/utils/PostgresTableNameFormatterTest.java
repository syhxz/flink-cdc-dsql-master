...
class PostgresTableNameFormatterTest {
    ...
    void testFormatTableListWithSchemaPrefix() {
        String[] result =
                PostgresTableNameFormatter.formatTableList("public", "schema1.table1,table2");
    ...
    void testEscapeIdentifier() {
        ...
        assertEquals(
                "\"table\"\"name\"", PostgresTableNameFormatter.escapeIdentifier("table\"name"));
        assertEquals(
                "\"already quoted\"",
                PostgresTableNameFormatter.escapeIdentifier("\"already quoted\""));
    }
}
