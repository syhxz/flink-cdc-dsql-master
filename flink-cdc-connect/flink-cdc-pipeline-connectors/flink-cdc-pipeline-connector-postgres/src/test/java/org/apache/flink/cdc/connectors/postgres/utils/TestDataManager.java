...
/**
 * Utility class for managing test data setup and cleanup in PostgreSQL integration tests. Provides
 * methods for creating test schemas, inserting test data, and cleaning up after tests.
 */
public class TestDataManager {
    ...
    /**
     * Sets up the complete test schema with all required tables. This method is idempotent and can
    ...
    /**
     * Inserts comprehensive test data into all tables. Uses ON CONFLICT clauses to make the
    ...
    /**
     * Inserts minimal test data for faster test execution. Use this method when full test data is
     * not required.
     *
     * @throws SQLException if data insertion fails
     */
    ...
    /**
     * Cleans up all test data from all tables. Uses CASCADE to handle foreign key constraints
     * properly.
     *
    ...
    /**
     * Drops all test tables and related objects. Use this method for complete cleanup when tables
    ...
    public void createCustomTable(String tableName, String columns) throws SQLException {
        ...
        String createTableScript =
                String.format("CREATE TABLE IF NOT EXISTS %s (%s);", tableName, columns);
     ...
     * @throws SQLException if data insertion fails
     */
    public void insertCustomData(String tableName, String columns, String values)
            throws SQLException {
    ...
    /**
     * Executes a SQL script by splitting it into individual statements. Handles comments and empty
