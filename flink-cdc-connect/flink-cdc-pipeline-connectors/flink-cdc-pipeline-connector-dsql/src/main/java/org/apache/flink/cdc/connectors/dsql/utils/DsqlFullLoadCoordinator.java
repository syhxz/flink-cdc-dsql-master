...
/**
 * Coordinator for managing full load operations in DSQL. Handles table creation, validation, and
 * tracking of created tables.
 */
public class DsqlFullLoadCoordinator {
    ...
    /**
     * Gets the target table name for DSQL. This method can be customized to implement table naming
     * strategies.
     *
