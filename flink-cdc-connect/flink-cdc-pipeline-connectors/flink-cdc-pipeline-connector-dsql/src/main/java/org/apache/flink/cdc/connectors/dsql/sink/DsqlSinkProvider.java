...
import static org.apache.flink.cdc.connectors.dsql.sink.DsqlSinkOptions.SSL_MODE;
import static org.apache.flink.cdc.connectors.dsql.sink.DsqlSinkOptions.USE_IAM_AUTH;

/** Provider for Amazon DSQL sink connections. Handles basic JDBC connection management for DSQL. */
public class DsqlSinkProvider {
    ...
    private Properties buildConnectionProperties() {
        ...
        // SSL configuration: respect explicit ssl-mode, otherwise auto-detect based on auth mode
