...
/**
 * Utility class for mapping schemas between source databases and Amazon DSQL. DSQL is
 * PostgreSQL-compatible, so we map to PostgreSQL data types.
 */
public class DsqlSchemaMapper {
    ...
    public static String generateUpdateStatement(Schema schema, String tableName) {
        ...
        List<String> whereClauses =
                primaryKeys.stream().map(key -> key + " = ?").collect(Collectors.toList());
