...
/**
 * Utility class for detailed error reporting in DSQL connector. Provides context-rich error
 * messages and categorizes different types of errors.
 */
public class DsqlErrorReporter {
    ...
    public static RuntimeException reportConnectionError(
            String operation, String host, int port, Throwable cause) {
        String message =
                String.format(
    ...
    public static RuntimeException reportAuthenticationError(
            String operation, String region, Throwable cause) {
        String message =
                String.format(
    ...
    public static RuntimeException reportSchemaError(
            String operation, TableId tableId, String schemaDetails, Throwable cause) {
        String message =
                String.format(
    ...
    public static RuntimeException reportDataTypeError(
            String operation,
            TableId tableId,
            String columnName,
            String sourceType,
    ...
    public static RuntimeException reportFullLoadError(
            String operation,
            TableId tableId,
    ...
    public static RuntimeException reportCdcError(
            String operation,
            TableId tableId,
            String eventType,
    ...
    public static RuntimeException reportConfigurationError(
            String configKey, String configValue, String expectedFormat, Throwable cause) {
        String message =
                String.format(
    ...
    public static RuntimeException reportSqlExecutionError(
            String operation, String sql, TableId tableId, SQLException cause) {
        String message =
                String.format(
    ...
    public static RuntimeException reportRetryExhaustionError(
            String operation, int maxRetries, long totalDuration, Throwable lastCause) {
        String message =
                String.format(
    ...
    public static Map<String, Object> createErrorContext(
            String operation, TableId tableId, Event event, Throwable cause) {
    ...
    public static void logErrorStatistics(
            String operation, ErrorCategory category, long duration, boolean recovered) {
        LOG.info(
                "Error statistics - Operation: {}, Category: {}, Duration: {}ms, Recovered: {}",
                operation,
                category,
                duration,
                recovered);
