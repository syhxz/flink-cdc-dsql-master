...
public class PostgresScanFetchTask extends AbstractScanFetchTask {
    ...
    public static class PostgresSnapshotSplitReadTask
        ...
        // This is a temporary solution - in production, this should be communicated through proper
        // channels
        ...
        protected SnapshotResult<PostgresOffsetContext> doExecute(
            ...
            if (globalSnapshotBeginOffset != null) {
                LOG.info(
                        "CDC will start from snapshot begin LSN: {} instead of high watermark",
        ...
        /**
         * Get the globally stored snapshot begin offset. This is used by the HybridSplitAssigner to
         * start CDC streaming from snapshot begin LSN.
         */
        ...
        /**
         * Reset the global snapshot begin offset. This should be called when starting a new job to
         * ensure clean state.
         */
